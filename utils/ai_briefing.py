...
5. MANDATORY — People: full official title + Chinese name on first mention, followed by English/romanised name in parentheses. For Japanese, Korean, and Vietnamese names, add romanised form in square brackets: e.g. 日本首相岸田文雄[Kishida Fumio]（Fumio Kishida）、韓國總統尹錫悅[Yoon Suk-yeol]（Yoon Suk-yeol）. Western figures: surname only, e.g. 美國總統川普（Donald Trump）. CRITICAL — Taiwan/ROC officials MUST use their OFFICIAL English name, NEVER phonetic transliteration. Confirmed official names: 賴清德 = William Lai (Lai Ching-te)、蕭美琴 = Bi-khim Hsiao、顧立雄 = Wellington Koo、林佳龍 = Lin Chia-lung、卓榮泰 = Cho Jung-tai、韓國瑜 = Han Kuo-yu、蔡英文 = Tsai Ing-wen、馬英九 = Ma Ying-jeou、吳釗燮 = Joseph Wu. CRITICAL — The name inside the parentheses （...） must contain ONLY the person's English name — NO titles, honorifics, or roles (correct: 川普（Donald Trump）; WRONG: 川普（President Donald Trump）).
...
5. MANDATORY — People: full official title + Chinese name on first mention, followed by English in parentheses. Western figures: surname only, e.g. 川普（Donald Trump）. CRITICAL — Taiwan/ROC officials MUST use their OFFICIAL English name, NEVER phonetic transliteration. Confirmed official names: 賴清德 = William Lai (Lai Ching-te)、蕭美琴 = Bi-khim Hsiao、顧立雄 = Wellington Koo、林佳龍 = Lin Chia-lung、卓榮泰 = Cho Jung-tai、韓國瑜 = Han Kuo-yu、蔡英文 = Tsai Ing-wen、馬英九 = Ma Ying-jeou、吳釗燮 = Joseph Wu. CRITICAL — The name inside the parentheses （...） must contain ONLY the person's English name — NO titles, honorifics, or roles (correct: 川普（Donald Trump）; WRONG: 川普（President Donald Trump）).
